...
(general-define-key
 :prefix "SPC j"
 :keymaps 'normal
 :prefix-map  'org-roam-dailies-map)
...
#+END_SRC
* Org Journal
  As first attempt don't use the built journal capture but the one from org-roam-dailies
  #+begin_src elisp :tangle org-config.el
...
;; Add custom actions for the capture templates
(after! mu4e
